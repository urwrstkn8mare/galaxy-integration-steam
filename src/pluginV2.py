...
class SteamPlugin(Plugin):
    ...
    Functionality is implemented by implementing abstract functions defined in the Plugin class from the galaxy api. Functions will be labeled as called by galaxy client where applicable.
...
or a NextStep object, which tells GOG to display a webpage with the information necessary to get further login information from the user.
        ...
        This function is called by the GOG Galaxy Client
        """
        pass
