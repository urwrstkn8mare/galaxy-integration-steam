...
class CChatRoom_GetMessageHistory_ResponseChatMessage(betterproto.Message):
    ...
    reactions: List[
        "CChatRoom_GetMessageHistory_ResponseChatMessageMessageReaction"
    ] = betterproto.message_field(7)


@dataclass
class CChatRoom_GetMessageHistory_ResponseChatMessageMessageReaction(
    betterproto.Message
):
...
@dataclass
class CChatRoom_UpdateMessageReaction_Request(betterproto.Message):
    chat_group_id: int = betterproto.uint64_field(1)
    chat_id: int = betterproto.uint64_field(2)
...
@dataclass
class CChatRoom_UpdateMessageReaction_Response(betterproto.Message):
    num_reactors: int = betterproto.uint32_field(1)


@dataclass
class CChatRoom_GetMessageReactionReactors_Request(betterproto.Message):
    chat_group_id: int = betterproto.uint64_field(1)
    chat_id: int = betterproto.uint64_field(2)
    server_timestamp: int = betterproto.uint32_field(3)
    ordinal: int = betterproto.uint32_field(4)
...
@dataclass
class CChatRoom_GetMessageReactionReactors_Response(betterproto.Message):
...
@dataclass
class CChatRoom_MessageReaction_Notification(betterproto.Message):
    chat_group_id: int = betterproto.uint64_field(1)
    chat_id: int = betterproto.uint64_field(2)
    server_timestamp: int = betterproto.uint32_field(3)
    ordinal: int = betterproto.uint32_field(4)
    reactor: float = betterproto.fixed64_field(5)
...
class CChatUsability_ClientUsabilityMetrics_Notification(betterproto.Message):
    ...
    settings: "CChatUsability_ClientUsabilityMetrics_NotificationSettings" = (
    ...
    ui_state: "CChatUsability_ClientUsabilityMetrics_NotificationUIState" = (
        betterproto.message_field(12)
    )
    metrics: "CChatUsability_ClientUsabilityMetrics_NotificationMetrics" = (
