...
_CMSGCLIENTGETUSERSTATS = DESCRIPTOR.message_types_by_name['CMsgClientGetUserStats']
_CMSGCLIENTGETUSERSTATSRESPONSE = DESCRIPTOR.message_types_by_name['CMsgClientGetUserStatsResponse']
_CMSGCLIENTGETUSERSTATSRESPONSE_STATS = _CMSGCLIENTGETUSERSTATSRESPONSE.nested_types_by_name['Stats']
_CMSGCLIENTGETUSERSTATSRESPONSE_ACHIEVEMENT_BLOCKS = _CMSGCLIENTGETUSERSTATSRESPONSE.nested_types_by_name['Achievement_Blocks']
_CMSGCLIENTSTOREUSERSTATSRESPONSE = DESCRIPTOR.message_types_by_name['CMsgClientStoreUserStatsResponse']
_CMSGCLIENTSTOREUSERSTATSRESPONSE_STATS_FAILED_VALIDATION = _CMSGCLIENTSTOREUSERSTATSRESPONSE.nested_types_by_name['Stats_Failed_Validation']
_CMSGCLIENTSTOREUSERSTATS2 = DESCRIPTOR.message_types_by_name['CMsgClientStoreUserStats2']
_CMSGCLIENTSTOREUSERSTATS2_STATS = _CMSGCLIENTSTOREUSERSTATS2.nested_types_by_name['Stats']
_CMSGCLIENTSTATSUPDATED = DESCRIPTOR.message_types_by_name['CMsgClientStatsUpdated']
_CMSGCLIENTSTATSUPDATED_UPDATED_STATS = _CMSGCLIENTSTATSUPDATED.nested_types_by_name['Updated_Stats']
_CMSGCLIENTSTOREUSERSTATS = DESCRIPTOR.message_types_by_name['CMsgClientStoreUserStats']
_CMSGCLIENTSTOREUSERSTATS_STATS_TO_STORE = _CMSGCLIENTSTOREUSERSTATS.nested_types_by_name['Stats_To_Store']
