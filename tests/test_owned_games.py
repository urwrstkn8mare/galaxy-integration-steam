...
@pytest.fixture
async def authenticated_plugin(mocker, games_cache_mock, create_authenticated_plugin):
    """Overridden version of the fixture with patched games_cache"""
    mocker.patch('plugin.GamesCache', return_value=games_cache_mock)
    return await create_authenticated_plugin('mock', 'mock', 'mock', {})
